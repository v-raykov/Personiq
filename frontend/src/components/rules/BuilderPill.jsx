...
import {getInitialValue, SUPPORTED_OPERATORS} from './operators';
            ...
            >
                ...
                <Select
                    ...
                    sx={{
                        ...
                        fontWeight: 700, '&:before, &:after': {display: 'none'}
                    }}
                >
                    ...
                    {item.valueMode === 'attribute' ? (
                        <Select
                            ...
                            sx={{
                                ...
                                px: 1, '&:before, &:after': {display: 'none'}
                            }}
                        >
                                ...
                                <MenuItem key={a.id} value={a.id}>
                                    <Box sx={{display: 'flex', alignItems: 'center', gap: 1, width: '100%'}}>
                                        <Box sx={{
                                            ...
                                            height: 6,
                                            borderRadius: '50%',
                                            bgcolor: a.entity === 'CUSTOMER' ? '#6366f1' : '#10b981'
                                        }}/>
