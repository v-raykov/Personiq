...
import {Box, Button, Card, Divider, IconButton, Stack, Typography, Zoom} from '@mui/material';
import {Add, DeleteOutline, Extension, HorizontalRule, SettingsInputComponent} from '@mui/icons-material';
                ...
                <Box sx={{p: 3, flexGrow: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column'}}>
                    <Stack direction="row" spacing={2} alignItems="center" sx={{mb: 2}}>
                        <Box sx={{
                            ...
                            <Icon sx={{color: '#818cf8', fontSize: '1.8rem'}}/>
                        </Box>
                        <Typography variant="h5" fontWeight={900} noWrap sx={{color: '#fff'}}>
                            {data?.name ? String(data.name).toUpperCase() : 'UNTITLED'}
                        </Typography>
                    </Stack>
                    ...
                    <Typography variant="caption"
                                sx={{color: '#64748b', fontWeight: 900, mb: 1.5, display: 'block', letterSpacing: 1.5}}>
                                    ...
                                    <Stack direction="row" spacing={1} alignItems="center">
                                        ...
                                        <Box>
                                            ...
                                            <Typography sx={{color: '#64748b', fontSize: '0.65rem', fontWeight: 800}}>
                                                {String(attr.valueType || attr.type)} {attr.isList ? '[]' : ''}
                                            </Typography>
                                        </Box>
                                    </Stack>
                                    <IconButton
