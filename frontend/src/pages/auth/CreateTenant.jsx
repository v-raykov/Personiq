...
import {Alert, Box, Button, Container, Fade, Paper, Snackbar, Stack, TextField, Typography} from '@mui/material';
        ...
        <PageWrapper withImage={true}>
            <Container maxWidth="xs">
                <Fade in timeout={800}>
                    <Box sx={{mt: 8, pb: 4}}>
                        <Link to="/"
                              style={{color: 'rgba(255,255,255,0.4)', textDecoration: 'none', fontSize: '0.85rem'}}>
                            ← Back to Selection
                        </Link>

                        <StyledPaper elevation={0}>
                            <Typography variant="h5" fontWeight={800} sx={{mb: 0.5}}>Create Tenant</Typography>
                            <Typography variant="body2" color="text.secondary" sx={{mb: 4}}>Initialize your new Personiq
                                space.</Typography>
                            ...
                            <Box component="form" onSubmit={handleSubmit}>
                                ...
                                <Stack spacing={2.5}>
                                    <Typography variant="overline"
                                                sx={{color: '#6366f1', fontWeight: 900, letterSpacing: 1.5}}>
                                    ...
                                    <Typography variant="overline"
                                                sx={{color: '#6366f1', fontWeight: 900, letterSpacing: 1.5, mt: 2}}>
